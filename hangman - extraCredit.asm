...
.data
	...
	lossCount BYTE 0d
	gameCount BYTE 0d
	winCountPrompt BYTE 'Games won: ',0
	lossCountPrompt BYTE 'Games lost: ',0
	gameCountPrompt BYTE 'Games played: ',0
...
displayStats PROC uses edx ecx edi
;Desc: puts stats
;recieves nothing
;returns stats
push edx

mov edx,OFFSET winCountPrompt
call writestring
mov al, winCount
call writedec
call crlf;endline

mov edx,OFFSET lossCountPrompt
call writestring
mov al, lossCount
call writedec
call crlf;endline

mov edx,OFFSET gameCountPrompt
call writestring
mov al, gameCount
call writedec
call crlf;endline
